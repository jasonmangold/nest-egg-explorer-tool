...
const Index = () => {
  ...
  const [advisorInfo, setAdvisorInfo] = useState<Advisor>({
    ...
    show_podcast: true,
    disclaimer_text:
      "The values shown are hypothetical illustrations and not a promise of future performance. They are not intended to provide financial advice. Contact a financial professional for more personalized recommendations.",
    phone: "",
    email: "",
    address: "",
  });
  ...
  const handleExportPDF = async () => {
    if (firstName && email) {
      ...
      pdf.text(
        `Prepared for: ${firstName} (${email}) on ${new Date().toLocaleDateString()}`,
        textX,
        contactY + boxHeight - 7,
      );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center px-4">
          ...
          <p className="text-lg text-slate-600">The advisor page you're looking for is not available on this domain.</p>
        </div>
      </div>
    );
  }
  return (
    <TooltipProvider>
      <div className="min-h-screen relative overflow-hidden bg-slate-50">
            ...
            <div className="container mx-auto px-4 max-w-6xl">
              <div className="text-center mb-8 sm:mb-12 px-2">
                ...
                <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
                  Plan your retirement spending with confidence. Our calculator shows you how much you can spend monthly
                ...
                <Card className="bg-white/95 backdrop-blur-lg border-0 shadow-xl ring-1 ring-slate-200/50">
                  <CardHeader className="px-4 sm:px-6">
                    ...
                    <CardDescription className="text-sm sm:text-base text-slate-600">
                      Enter your current savings and spending goal to see your retirement projection
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Label htmlFor="savings" className="text-sm sm:text-base font-medium text-slate-700">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-8 text-base sm:text-lg h-11 sm:h-12 border-slate-200 focus:border-primary focus:ring-primary"
                          placeholder="500,000"
                          aria-label="Total retirement savings amount"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Label htmlFor="spending" className="text-sm sm:text-base font-medium text-slate-700">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-8 text-base sm:text-lg h-11 sm:h-12 border-slate-200 focus:border-primary focus:ring-primary"
                          placeholder="3,000"
                          aria-label="Desired monthly spending in retirement"
                        />
                      </div>
                    </div>
                    ...
                    <div className="pt-2 sm:pt-4">
                      <Button
                        ...
                        className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-11 sm:h-12 text-base sm:text-lg font-semibold touch-manipulation"
                      ...
                      >
                        ...
                        <span className="sm:hidden">
                          {hasCalculated && needsCalculation ? "Recalculate" : "Calculate Plan"}
                        </span>
                      </Button>
                      {needsCalculation && (
                        <p className="text-xs sm:text-sm text-amber-600 mt-2 text-center">
                ...
                <Card className="bg-white/95 backdrop-blur-lg border-0 shadow-xl ring-1 ring-slate-200/50">
                  <CardHeader className="px-4 sm:px-6">
                    <CardTitle className="text-xl sm:text-2xl text-slate-800">
                      Retirement Spend-Down Projection
                    </CardTitle>
                    <CardDescription className="text-sm sm:text-base text-slate-600">
                      The graph below shows how long your retirement savings will last.
                    </CardDescription>
                  </CardHeader>
                    ...
                    {hasCalculated && !needsCalculation ? (
                      <>
                        ...
                        <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                          <div
                            className={`p-3 sm:p-4 rounded-lg ${isMoneyLasting ? "bg-primary/10 border border-primary/20" : "bg-red-50 border border-red-200"}`}
                          >
                            <h2
                              className={`font-semibold text-base sm:text-lg ${isMoneyLasting ? "text-primary" : "text-red-800"}`}
                            >
                              {isMoneyLasting
                                ? "✓ Money Lasts 30+ Years"
                                : `⚠ Money Runs Out in ${yearsUntilEmpty} year${yearsUntilEmpty !== 1 ? "s" : ""}${monthsUntilEmpty > 0 ? ` and ${monthsUntilEmpty} month${monthsUntilEmpty > 1 ? "s" : ""}` : ""}`}
                            </h2>
                            <p
                              className={`text-xs sm:text-sm mt-1 ${isMoneyLasting ? "text-primary" : "text-red-600"}`}
                            >
                              {isMoneyLasting
                                ? "Your spending plan looks sustainable for a 30-year retirement."
                                : "Consider reducing spending or saving more to extend your money."}
                          ...
                          <div className="bg-primary/10 border border-primary/20 p-3 sm:p-4 rounded-lg">
                            ...
                            <p className="text-xl sm:text-2xl font-bold text-primary mt-1">
                              ${safeMonthlyAmount.toLocaleString()}
                            </p>
                            <p className="text-xs sm:text-sm text-primary mt-1">
                              Sustainable for 30 years with 3% annual increases
                            </p>
                          </div>
                          ...
                          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                            <DialogTrigger asChild>
                              <Button
                                variant="outline"
                                className="w-full border-primary/20 text-primary hover:bg-primary/10 h-10 sm:h-11 text-sm sm:text-base touch-manipulation"
                                aria-label="Export retirement results as PDF"
                              >
              ...
              {advisorInfo.show_podcast ? (
                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12 px-2 sm:px-0">
                  ...
                  <Card className="bg-gradient-to-br from-slate-700 via-emerald-700 to-teal-700 text-white border-0 shadow-2xl">
                    <CardContent className="p-6 sm:p-8">
                      ...
                      <p className="text-white/90 mb-4 sm:mb-6 text-sm sm:text-base">
                        Discover how much you can safely spend in retirement by understanding this online calculator.
                        We'll unpack why this tool is just a starting point, emphasizing the need for a personalized
                        plan to build the retirement you envision.
                      </p>
                      <Button
                        size="lg"
                        className="bg-white text-emerald-700 hover:bg-emerald-50 w-full sm:w-auto h-11 sm:h-12 touch-manipulation"
                        onClick={handleListenNow}
                        aria-label="Listen to retirement podcast"
                      >
                  ...
                  <Card className="bg-gradient-to-br from-slate-700 via-emerald-700 to-teal-700 text-white border-0 shadow-2xl">
                    <CardContent className="p-6 sm:p-8">
                      ...
                      <Button
                        size="lg"
                        className="bg-white text-primary hover:bg-white/90 w-full sm:w-auto h-11 sm:h-12 touch-manipulation"
                        onClick={handleContactClick}
                        aria-label="Schedule appointment with financial advisor"
                      >
                        Find a Time
                ...
                <div className="text-center mt-8 sm:mt-12 px-2 sm:px-0">
                  <Card className="bg-gradient-to-br from-slate-700 via-emerald-700 to-teal-700 text-white border-0 shadow-2xl max-w-2xl mx-auto">
                    <CardContent className="p-6 sm:p-8">
                      <PiggyBank
                        className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 opacity-90"
                        aria-hidden="true"
                      />
                      <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">
                      ...
                      <p className="text-white/90 mb-4 sm:mb-6 text-sm sm:text-base">
                        ...
                        financial representative can help you create a comprehensive strategy that balances debt
                        management with long-term financial security and wealth building.
                      </p>
                      <Button
                        size="lg"
                        className="bg-white text-primary hover:bg-white/90 w-full sm:w-auto h-11 sm:h-12 touch-manipulation"
                        onClick={handleContactClick}
                        aria-label="Schedule consultation with financial advisor"
                      >
                        Find a Time
                        <ExternalLink className="w-4 h-4 ml-2" aria-hidden="true" />
                      </Button>
        ...
        <section
          className="relative py-12 sm:py-16 bg-gradient-to-br from-slate-200 via-primary/5 to-secondary/5 backdrop-blur-sm"
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
              ...
              <div>
                <div className="text-center mb-6 sm:mb-8">
                  <BookOpen
                    className="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-primary mb-3 sm:mb-4"
                    aria-hidden="true"
                  />
                ...
                <div className="space-y-4">
                  {learnMoreTemplates.map((template, index) => {
                    ...
                    return (
                      <Card
                        key={template.id}
                        className="hover:shadow-lg transition-all duration-300 bg-white/90 backdrop-blur-sm border-0 ring-1 ring-slate-200/50 hover:ring-primary/30 h-40"
                      >
        ...
        <section
          id="contact-section"
          className="relative py-12 sm:py-16 bg-gradient-to-br from-primary/5 via-secondary/5 to-primary/5 backdrop-blur-sm"
        ...
        >
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-lg text-slate-600 px-4">
                Ready to discuss your retirement planning? Get in touch today.
              </p>
            </div>
                  ...
                  <div className="space-y-4 sm:space-y-6 order-2 md:order-1">
                    {advisorInfo.phone && (
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div>
                          ...
                          <a
                            href={`tel:${advisorInfo.phone}`}
                            className="text-sm sm:text-base text-slate-600 hover:text-primary transition-colors"
                          >
                            {advisorInfo.phone}
                          </a>
                        </div>
                      ...
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div className="min-w-0">
                          ...
                          <a
                            ...
                            className="text-sm sm:text-base text-slate-600 hover:text-primary transition-colors break-all"
                          >
                            {advisorInfo.email}
                          </a>
                        </div>
                    ...
                    {advisorInfo.address && (
                      <div className="flex items-start space-x-3 sm:space-x-4">
                        ...
                        <div>
                          ...
                          <address className="text-sm sm:text-base text-slate-600 whitespace-pre-line not-italic">
                            {advisorInfo.address}
                          </address>
                        </div>
                      </div>
                    ...
                    {!advisorInfo.phone && !advisorInfo.email && !advisorInfo.address && (
                      <div className="text-center py-8">
                        <p className="text-slate-600 text-sm sm:text-base">Contact information coming soon.</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="text-center order-1 md:order-2">
                    {advisorInfo.photoUrl ? (
                      <img
                        ...
                        alt={`${advisorInfo.name}, ${advisorInfo.title} - Professional headshot`}
                        className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 mx-auto rounded-full object-cover mb-3 sm:mb-4"
                        loading="lazy"
                      />
                    ) : (
                      <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 mx-auto bg-gradient-to-br from-primary/20 to-secondary/30 rounded-full flex items-center justify-center mb-3 sm:mb-4">
                        <Users
                          className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-primary opacity-60"
                          aria-hidden="true"
                        />
                      </div>
                    )}
        ...
        {/* Disclaimer */}
        <footer
          className="relative py-8 sm:py-12 bg-gradient-to-t from-slate-100/90 to-white/60 backdrop-blur-sm"
          role="contentinfo"
        >
          <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
            <div className="text-center">
              <h2 className="text-base sm:text-lg font-semibold text-slate-800 mb-3 sm:mb-4">Important Disclaimer</h2>
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">{advisorInfo.disclaimer_text}</p>
            </div>
          </div>
        </footer>
